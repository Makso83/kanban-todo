...
/* harmony import */ var moment_locale_ru__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment/locale/ru */ "./node_modules/moment/locale/ru.js");
...
moment.locale('ru');
var Task = (function () {
    function Task(title, timestamp, status) {
    ...
    Task.prototype.dragStartHandler = function (event) {
...
var TaskState = (function () {
    function TaskState() {
        ...
        this.taskList = [];
        this.listeners = [];
        var dataFromLocalStorage = window.localStorage.getItem('tasks');
        if (dataFromLocalStorage) {
            var listFromLocalS = JSON.parse(dataFromLocalStorage);
            this.taskList = listFromLocalS.map(function (prj) { return new Task(prj.title, prj.timestamp, prj.status); });
    ...
    TaskState.prototype.updateState = function () {
        this.updateListeners();
        this.updateLocalStorage();
    };
    TaskState.prototype.updateLocalStorage = function () {
    ...
    TaskState.prototype.moveTask = function (taskId, newStatus) {
        var selectedTask = this.taskList.find(function (task) { return task.id === taskId; });
        if (selectedTask) {
            selectedTask.status = newStatus;
            this.updateState();
        }
    };
    TaskState.prototype.removeTask = function (taskId) {
        this.taskList = this.taskList.filter(function (tsk) { return tsk.id !== taskId; });
        this.updateState();
    };
...
var Desk = (function () {
    ...
    Desk.prototype.dragOverHandler = function (event) {
        event.preventDefault();
        if (!this.element.classList.contains('kanban-desk--dropable')) {
            this.element.classList.add('kanban-desk--dropable');
        }
    };
    Desk.prototype.dropHandler = function (event) {
        taskState.moveTask(event.dataTransfer.getData('text/plain'), this.element.id);
        this.element.classList.remove('kanban-desk--dropable');
    };
    Desk.prototype.dragLeaveHandler = function () {
        this.element.classList.remove('kanban-desk--dropable');
    };
    Desk.prototype.configure = function () {
        this.element.addEventListener('dragover', this.dragOverHandler.bind(this));
        this.element.addEventListener('dragleave', this.dragLeaveHandler.bind(this));
        this.element.addEventListener('drop', this.dropHandler.bind(this));
    };
    Desk.prototype.buildTaskContent = function (tsk) {
    ...
    Desk.prototype.renderContent = function () {
        ...
        this.adjustedProjects.map(function (prj) {
            list.insertAdjacentElement('beforeend', _this.buildTaskContent(prj));
        });
    };
    return Desk;
}());
